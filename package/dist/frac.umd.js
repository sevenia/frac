(function (global, factory) {
    ...
    const _hoisted_5$2 = { class: "f_relative f_flex-shrink-0 f_z-20" };
    const _hoisted_6$2 = {
      key: 1,
    ...
    let field = vue.inject('field', null);
    if (!field) {
        field = veeValidate.useField(props.name, props.validation, {
    ...
    */
      ...
      return (vue.openBlock(), vue.createElementBlock("div", null, [
        (__props.texts.label)
          ? (vue.openBlock(), vue.createElementBlock("label", {
              key: 0,
              for: __props.name,
              class: vue.normalizeClass(["f_font-bold f_pl-1 f_mt-1 f_mb-1 f_block f_text-sm f_font-medium f_leading-5 f_text-gray-700", vue.unref(getClasses)('label')])
            }, [
              vue.renderSlot(_ctx.$slots, "label", {}, () => [
                vue.createTextVNode(vue.toDisplayString(__props.texts.label), 1)
              ])
            ], 10, _hoisted_1$7))
          : vue.createCommentVNode("", true),
        vue.createElementVNode("div", {
          class: vue.normalizeClass(["f_rounded-sm f_shadow-sm f_flex f_shadow-sm focus-within:f_ring-2 focus-within:f_ring-gray-200 focus-within:f_ring-opacity-60", vue.unref(getClasses)('inner')])
        }, [
        ...
        (vue.unref(errors).length > 0)
          ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_6$2, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(errors), (error) => {
                return vue.renderSlot(_ctx.$slots, "error", { error: error }, () => [
                  vue.createElementVNode("span", _hoisted_7$1, vue.toDisplayString(_ctx.$i18n.translate(error)), 1)
                ])
              }), 256))
            ]))
          : vue.createCommentVNode("", true)
    ...
    function _sfc_render$1(_ctx, _cache) {
      return (vue.openBlock(), vue.createElementBlock("button", _hoisted_1$4, [
    ...
    const _hoisted_6$1 = /*#__PURE__*/vue.createTextVNode(" __MISSING_EDITOR__ ");
    ...
    const field = veeValidate.useField(props.name, props.validation, {
        initialValue: props.modelValue,
    });
    vue.provide('field', field);

    const editable = vue.ref(!!props.editable);
    let isEditing = vue.ref(false);
    let newValue = vue.ref(field.value);
    ...
    return (_ctx, _cache) => {
      return (vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["f_my-2 f_px-2 f_-mx-2 md:f_pb-0 md:f_flex md:f_overflow-hidden first:f_mt-0", getClasses('row')])
      }, [
        vue.createElementVNode("div", _hoisted_1$3, [
          vue.createElementVNode("label", {
            for: __props.name,
            class: "f_flex-grow f_font-bold f_block md:f_block md:f_truncate"
          }, vue.toDisplayString(__props.texts.label), 9, _hoisted_2$1),
          (__props.texts.infotext)
            ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_3$1, vue.toDisplayString(__props.texts.infotext), 1))
            : vue.createCommentVNode("", true)
        ]),
        (vue.unref(isEditing))
          ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$1, [
              vue.createElementVNode("div", {
                onKeyup: vue.withKeys(cancelEdit, ["esc"]),
                onKeydown: vue.withKeys(confirmEdit, ["enter"])
              }, [
                vue.renderSlot(_ctx.$slots, "editor", {
                  value: vue.unref(newValue),
                  setValue: setValue
                }, () => [
                  _hoisted_6$1
                ])
              ...
              vue.createElementVNode("div", _hoisted_7, [
                vue.createVNode(_sfc_main$4, {
                  ...
                  text: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(_ctx.$i18n.translate('cancel')), 1)
                  ]),
                  _: 1
                }),
                vue.createVNode(_sfc_main$4, {
                  ...
                  text: vue.withCtx(() => [
                    vue.createTextVNode(vue.toDisplayString(_ctx.$i18n.translate('confirm')), 1)
                  ]),
                  _: 1
                })
              ])
            ]))
          : (vue.openBlock(), vue.createElementBlock("p", _hoisted_8, [
              vue.renderSlot(_ctx.$slots, "default", { value: __props.modelValue }, () => [
                vue.createTextVNode(vue.toDisplayString(__props.modelValue), 1)
              ])
            ])),
        (editable.value && !vue.unref(isEditing))
          ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9, [
              (editable.value && !vue.unref(isEditing))
                ? (vue.openBlock(), vue.createElementBlock("a", {
                    ...
                    onClick: vue.withModifiers(startEdit, ["prevent"])
                  }, vue.toDisplayString(_ctx.$i18n.translate('edit')), 9, _hoisted_10))
                : vue.createCommentVNode("", true)
            ]))
          : vue.createCommentVNode("", true)
      ], 2))
...
//# sourceMappingURL=frac.umd.js.map
