import { openBlock, createElementBlock, createElementVNode, ref, onMounted, inject, useSlots, normalizeClass, unref, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createVNode, Fragment, renderList, provide, onUnmounted, withKeys, withCtx, withModifiers, resolveComponent, normalizeProps, guardReactiveProps } from 'vue';
...
return (_ctx, _cache) => {
  return (openBlock(), createElementBlock("div", null, [
    ...
    (unref(errors).length > 0)
      ? (openBlock(), createElementBlock("p", _hoisted_6$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(errors), (error) => {
            return renderSlot(_ctx.$slots, "error", { error: error }, () => [
              createElementVNode("span", _hoisted_7$1, toDisplayString(_ctx.$i18n.translate(error)), 1)
            ])
          }), 256))
        ]))
      : createCommentVNode("", true)
